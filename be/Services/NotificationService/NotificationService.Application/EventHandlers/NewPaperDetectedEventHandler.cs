...
public class NewPaperDetectedEventHandler : IIntegrationEventHandler<NewPaperDetectedEvent>
{
    private readonly INotificationService _notificationService;
    private readonly IFollowRepository _followRepository;

    public NewPaperDetectedEventHandler(INotificationService notificationService, IFollowRepository followRepository)
    {
        _notificationService = notificationService;
        _followRepository = followRepository;
    }

    public async Task HandleAsync(NewPaperDetectedEvent @event, CancellationToken cancellationToken = default)
    {
